...
public class EditRealEstatePostRequestDto {
    ...
    @Builder
    public EditRealEstatePostRequestDto(String title, String body, SubCategoryType subCategory, PostStatus postStatus, String thumbnailUrl, Long innerArea, Long totalArea, State state, Long price, ProductStatus productStatus, ProductType productType) {
        this.title = title;
        this.body = body;
